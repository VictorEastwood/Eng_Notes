...
| resilience   | n. | 恢复力；韧性  | /rɪˈzɪliəns/       | Children often show remarkable resilience in adapting to new environments. 孩子们在适应新环境时常常表现出非凡的恢复力。 | re(重新)+sil(跳)      |
| scrutinize   | v.| 仔细检查      | /ˈskruːtənaɪz/     | Researchers must scrutinize data before drawing conclusions. 研究人员在得出结论之前必须仔细检查数据。      | 音似"scrutiny"        |
| proterozoic  | adj. | 前寒武纪的 | /ˌprɒtərəˈzəʊɪk/   | The proterozoic era is characterized by the emergence of simple life forms. 前寒武纪时期的特征是简单生命形式的出现。 | proterozoic(前寒武纪的)→前寒武纪的 |
| deterioration | n. | 恶化；退化  | /dɪˌtɪəriəˈreɪʃn/  | The deterioration of the environment is a pressing global issue. 环境恶化是一个紧迫的全球性问题。 | deteriorate(恶化)→恶化的过程 |
...
| flaw | n. | 缺陷；瑕疵 | /flɔː/               | The flaw in the design caused the product to malfunction. 设计中的缺陷导致产品发生故障。 | flaw(缺陷)→缺陷的意思 |
| heighten | v. | 提高；增强 | /ˈhaɪtn/            | The campaign aims to heighten awareness about climate change. 该活动旨在提高人们对气候变化的认识。 | height(高度)+en(使)→使高度增加 |
| humiliate | v. | 羞辱；使丢脸 | /hjuːˈmɪlieɪt/      | The teacher did not intend to humiliate the student in front of the class. 老师并不打算在全班面前羞辱学生。 | hum(地)+iliate(使)→使人感到低下 |
| sterilize | v. | 消毒；灭菌 | /ˈsterəlaɪz/        | It is essential to sterilize medical equipment to prevent infections. 消毒医疗设备对于预防感染至关重要。 | steril(消毒)+ize(使)→使消毒 |
...
| domesticate | v. | 驯化；使适应家庭生活 | /dəˈmæsɪkeɪt/       | The process of domestication has allowed humans to raise animals for food and companionship. 驯化过程使人类能够饲养动物以供食用和陪伴。 | dom(家)+esticate(使)→使适应家庭生活 |
| electron | n. | 电子 | /ɪˈlektrɒn/         | Electrons are fundamental particles that carry a negative charge. 电子是携带负电荷的基本粒子。 | electro(电)+n(粒子)→电子 |
| inhabit | v. | 居住；栖息 | /ɪnˈhæbɪt/          | Many species inhabit the dense forests of the Amazon. 许多物种栖息在亚马逊的密林中。 | in(在内)+habit(居住)→在内居住 |
| inhabitant | n. | 居民；栖息者 | /ɪnˈhæbɪtənt/       | The island's inhabitants have a unique culture and way of life. 岛上的居民有着独特的文化和生活方式。 | inhabit(居住)+ant(人)→居住的人 |
| accustom | v. | 使习惯；使适应 | /əˈkʌstəm/          | It took time for her to accustom herself to the new environment. 她花了一段时间才适应新的环境。 | ac(加强)+custom(习惯)→加强习惯 |
| narrative | n. | 叙述；故事 | /ˈnærətɪv/          | The narrative of the novel explores themes of love and betrayal. 小说的叙述探讨了爱情和背叛的主题。 | narr(叙述)+ative(的)→叙述的故事 |
| optimal | adj. | 最佳的；最优的 | /ˈɒptɪməl/          | The team developed an optimal solution to the complex problem. 团队开发了一个复杂问题的最佳解决方案。 | opt(选择)+imal(的)→最佳的选择 |
